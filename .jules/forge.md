...
## 2026-07-19 - Pinned Production Docker Images
**Issue:** Production docker-compose file used 'latest' and 'stable' tags for critical services, which is a deployment anti-pattern.
**Root Cause:** The docker/docker-compose.prod.yml file had hardcoded floating tags for services like Prometheus, Grafana, IPFS, ClamAV, and Certbot.
**Fix:** Pinned external services to specific valid tags.
