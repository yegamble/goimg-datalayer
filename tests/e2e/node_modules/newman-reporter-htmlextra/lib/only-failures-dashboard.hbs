        ...
        <div class="col-sm-12 mb-3">
            <div class="card border-info">
                ...
                <div class="dyn-height">
                    <pre class="renderMarkdown">{{collection.description}}</pre>
                </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card border-info" style="width: 50rem;">
                            ...
                            <div>
                                ...
                                <div class="progress" style="height: 40px;">
                                    ...
                                    <h5><strong>{{#gte cumulativeTests.passed 1}}{{percent cumulativeTests.passed cumulativeTests.failed}} %{{else}}0 %{{/gte}}</strong></h5>
                                    </div>
                                </div>
                                {{else}}
                                <div class="progress" style="height: 40px;">
